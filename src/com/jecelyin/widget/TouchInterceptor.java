...
public class TouchInterceptor extends ListView {
    ...
    private void updateItemHeight()
    {
        ...
        for(int i=0; ;i++)
        {
            ...
            if(v == null)
                break;
            id = v.getId();
            if(id==R.layout.tool_settings_list)
            {
                mItemHeightNormal = v.getHeight();
                mItemHeightHalf = mItemHeightNormal / 2;
                mItemHeightExpanded = mItemHeightNormal * 2;
            }else if(id==R.layout.tool_settings_divider){
                mDividerHeight = v.getHeight();
            }
        }
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {//first
        if (mDragListener != null || mDropListener != null) {
            ...
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    View dragger = item.findViewById(R.id.func_drag_handle);
                    if(dragger==null)
                        break;
                    Log.d("TI", "x:"+x+" left:"+dragger.getLeft()+" right:"+dragger.getRight());
    ...
    private void doExpansion() {
        ...
        for (int i = 0;; i++) {
            ...
            int height = vv.getId()==R.layout.tool_settings_divider ? mDividerHeight : mItemHeightNormal;
