...
import com.jecelyin.util.RfoColorPicker.OnColorChangedListener;

public class RfoColorPickerView extends View {
    ...
    public RfoColorPickerView(Context context, AttributeSet attr)
    {
        super(context, attr);
        init();
    }
    
    public RfoColorPickerView(Context c) {
        super(c);
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTrackingCenter) {
                    ...
                    if (mListener != null) {
                        mListener.onColorChanged("",RfoColorPicker.getColor(newcolor));
                    }
