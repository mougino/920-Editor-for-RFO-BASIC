...
import com.jecelyin.util.RfoColorPicker;
...
public class JecEditor extends BaseActivity
{
    ...
    private ImageButton launchRfoBtn;
	...
	*/
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        launchRfoBtn = (ImageButton) findViewById(R.id.launchrfo);
	copyBtn = (ImageButton) findViewById(R.id.upbar_copy);
	cutBtn = (ImageButton) findViewById(R.id.upbar_cut);
	pasteBtn = (ImageButton) findViewById(R.id.upbar_paste);
	gotoBtn = (ImageButton) findViewById(R.id.upbar_goto);
...
/*        
        last_edit_back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                } //else { Toast.makeText(JecEditor.this, R.string.not_need_back, Toast.LENGTH_LONG).show(); }
            }
        });
        last_edit_forward.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(mEditText.isCanForwardEditLocation())
                {
                    ...
                    onEditLocationChanged(mEditText);
                } //else { Toast.makeText(JecEditor.this, R.string.not_need_forward, Toast.LENGTH_LONG).show(); }
            }
        });
*/
...
*/
    ...
    class RfoColorListener implements RfoColorPicker.OnColorChangedListener
    {
        @Override
    ...
    private void bindEvent()
    {
        ...
        launchRfoBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v)
            {
                if("".equals(mEditText.getPath()) || mEditText.isTextChanged())
                ...
                try
                {
					...
					i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);	// important to launch new task
					i.setComponent(new ComponentName("com.rfo.basic", "com.rfo.basic.Basic"));
	...
	copyBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
		dispatchKeyShortcutEvent(new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_C));
	    }
        });
	...
	cutBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
		dispatchKeyShortcutEvent(new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_X));
	    }
        });
	...
	pasteBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
		dispatchKeyShortcutEvent(new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_V));
	    }
        });
	...
	gotoBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
		dispatchKeyShortcutEvent(new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_G));
            }
        });
        ...
        colorButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
            {
                RfoColorPicker cp = new RfoColorPicker(JecEditor.this, new RfoColorListener(), "edittext", JecEditor.this.getString(R.string.insert_color), Color.GREEN);
                cp.show();
            }
        });
		...
		if(findLayout.getVisibility() == View.GONE) {
			...
			replaceShowButton.setVisibility(View.GONE);
			findLayout.setVisibility(View.GONE);
		}
            }
        });
...
*/
    ...
    private OnClickListener onBtnSaveClicked = new OnClickListener() {
        ...
        public void onClick(View v)
        {
            if("".equals(mEditText.getPath()))
            {
                openFileBrowser(FILE_BROWSER_SAVEAS_CODE, getString(R.string.new_filename) + ".bas");
                return;
            }
            save();
        }
...
/*    public void removeHighlight()
    ...
    {
        if(type.toUpperCase().startsWith("HTM"))
        {
    ...
    private OnMenuItemSelectedListener mOnMenuItemSelectedListener = new OnMenuItemSelectedListener() {
        ...
        public boolean onMenuItemSelected(int id, View v)
        {
			...
			if(mEditText != null) {
				searchIntent.putExtra("keyword", mEditText.getText().subSequence(mEditText.getSelectionStart(), mEditText.getSelectionEnd()).toString());
				searchIntent.putExtra("path", mEditText.getPath());
			} else {
				searchIntent.putExtra("keyword", "");
				searchIntent.putExtra("path", "");
			}
			searchIntent.putExtra("isRoot", EditorSettings.TRY_ROOT);
			searchIntent.setClass(JecEditor.this, Grep.class);
			...
			break;
                ...
                case R.id.menu_preferences:
                    Intent jecIntent = new Intent(JecEditor.this, EditorPreference.class);
                    startActivity(jecIntent);
                    break;
                case R.id.menu_exit:
